...
public class MyTile {
	...
	public MyTile(MyTile tile) {
		this(tile.getTileColumn(), tile.getTileRow(), tile.getTileValue());
	}
	...
	public boolean equals(MyTile tile) {
		if (this.getTileColumn() == tile.getTileColumn() && this.getTileRow() == tile.getTileRow())
			return true;
		else
			return false;
	}

	// after testing on PipeGameBoard, need to make this generic, should be
	// (doAction) or something like that
